...
export class PaymentIntentsController {
   ...
   * Lista pares cripto/rede dispon√≠veis (filtrado pela allowlist + Cryptomus)
   */
  @Get('crypto/services')
  async getServices() {
   ...
   * Submete Binance Gift Card (ou voucher gen√©rico) para um pedido
   */
  ...
  async submitVoucher(
    ...
    try {
      ...
      // Re-lan√ßa com mensagem leg√≠vel (√∫til para debug)
   ...
   * Estado r√°pido para polling do frontend
   */
   ...
   * DiagnÛstico ó retorna serviÁos brutos da Cryptomus (sem filtro)
   * REMOVER em produÁ„o final
   */
